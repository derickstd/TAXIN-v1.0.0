...
def _get_job_task_counts(job):
    ...
    unpaid_statuses = ['handled_not_paid', 'bad_debt', 'not_handled']
    ...
    if request.method == 'POST':
        ...
        if new_status in dict(JobCardLineItem.ITEM_STATUS):
            ...
            if all_items:
                ...
                any_in_progress = any(li.status in ('handled_paid', 'handled_not_paid', 'bad_debt', 'paid_not_handled') for li in all_items)
            ...
            handled_state = new_status in {'handled_paid', 'handled_not_paid', 'bad_debt'}
